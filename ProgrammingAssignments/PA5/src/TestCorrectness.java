...
public class TestCorrectness {
	...
	static final String SCC1_GRAPH_PATH = "scc1.txt";
	static final String SCC2_GRAPH_PATH = "scc2.txt";
	static final String SCC3_GRAPH_PATH = "scc3.txt";
	static final String SCC4_GRAPH_PATH = "scc4.txt";
